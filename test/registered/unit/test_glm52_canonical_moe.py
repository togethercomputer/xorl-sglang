...
class TestGlm52CanonicalMoE(unittest.TestCase):
            ...
            for cp_rank in range(cp_size):
                ...
                with (
                    ...
                    communicator = NSACPLayerCommunicator(
                        ...
                        moe_output_layout=NSAMoEOutputLayout.REPLICATED_CANONICAL,
                    )
    ...
    def test_decoder_constructor_declares_canonical_nsa_layout(self):
        ...
        from sglang.srt.layers.communicator_nsa_cp import NSAMoEOutputLayout
        from sglang.srt.models.deepseek_v2 import (
            DeepseekV2DecoderLayer,
            DeepseekV2MoE,
        )
    ...
    def test_balanced_reference_and_plan_for_2_4_8_contributors(self):
        for contributors in (2, 4, 8):
