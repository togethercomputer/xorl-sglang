...
def __apply_patch__(mod):
    mod.YaRNScalingMRotaryEmbedding._cos_sin_cache_inv_freq = rebind(
        _YaRNScalingMRotaryEmbedding___cos_sin_cache_inv_freq,
        mod,
        name="_cos_sin_cache_inv_freq",
    )
    mod.YaRNScalingMRotaryEmbedding._cos_sin_cache_mscale = rebind(
        _YaRNScalingMRotaryEmbedding___cos_sin_cache_mscale,
        mod,
        name="_cos_sin_cache_mscale",
    )
    mod.YaRNScalingMRotaryEmbedding._cos_sin_cache_positions = rebind(
        _YaRNScalingMRotaryEmbedding___cos_sin_cache_positions,
        mod,
        name="_cos_sin_cache_positions",
    )
    mod.MRotaryEmbedding.forward_native = rebind(
        _MRotaryEmbedding__forward_native, mod, name="forward_native"
    )
