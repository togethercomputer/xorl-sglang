...
def __apply_patch__(mod):
    mod.YaRNScalingRotaryEmbedding._cos_sin_cache_inv_freq = rebind(_YaRNScalingRotaryEmbedding___cos_sin_cache_inv_freq, mod, name="_cos_sin_cache_inv_freq")
    mod.YaRNScalingRotaryEmbedding._cos_sin_cache_mscale = rebind(_YaRNScalingRotaryEmbedding___cos_sin_cache_mscale, mod, name="_cos_sin_cache_mscale")
    mod.YaRNScalingRotaryEmbedding._cos_sin_cache_positions = rebind(_YaRNScalingRotaryEmbedding___cos_sin_cache_positions, mod, name="_cos_sin_cache_positions")
