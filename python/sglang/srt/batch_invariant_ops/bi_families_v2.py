...
#
# These trees are selected structurally by the exact model contract. Stock
# lanes never reach them, and there is no environment rollback surface.
#
...
def families_v2_enabled() -> bool:
    """Return the structurally selected v2 numerical family."""
    return True
