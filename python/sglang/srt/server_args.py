...
class ServerArgs:
    ...
    def _resolve_dsv4_flash_exact_contract(
        ...
        *,
        ...
        # selects the exact arithmetic implementation without certifying one
        # model checkpoint or distributed topology.
        exact_arithmetic = {
        ...
        incompatible = [
            f"{name}={value!r}"
            for name, (value, allowed) in exact_arithmetic.items()
